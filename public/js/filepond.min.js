...
! function (e, t) {
    ...
    var t, n, r = function (e, t) {
        ...
        f = function (e, t, n, r) {
            ...
            }), d(s.inner), s.outer.bottom += s.element.marginBottom, s.outer.right += s.element.marginRight, d(s.outer), s
        },
        p = function (e, t) {
                    ...
                    p = o({
                        interpolate: function () {
                            if (!f) {
                                ...
                                }(l += c += -(l - s) * n / u, s, c *= i) ? p.onupdate(l): (l = s, c = 0, f = !0, p.onupdate(l), p.oncomplete(l))
                            }
                        },
                        target: {
                            set: function (e) {
                                if (E(e) && !E(l) && (l = e), null === s && (s = e, l = e), l === (s = e) || void 0 === s) return f = !0, c = 0, p.onupdate(l), void p.oncomplete(l);
                                f = !1
                            },
                            get: function () {
                                return s
                ...
                var e, t, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    E = o({
                        interpolate: function (n) {
                            f || null === d || (null === c && (c = n), n - c < l || ((e = n - c - l) < i ? (t = e / i, E.onupdate((e >= 0 ? u(p ? 1 - t : t) : 0) * d)) : (e = 1, t = p ? 0 : 1, E.onupdate(t * d), E.oncomplete(t * d), f = !0)))
                        },
                        target: {
                            get: function () {
                                return p ? 0 : d
                            ...
                            set: function (e) {
                                if (null === d) return d = e, E.onupdate(e), void E.oncomplete(e);
                                e < d ? (d = 1, p = !0) : (p = !1, d = e), f = !1, c = null
                            }
                        },
                        resting: {
                            get: function () {
        ...
        O = {
            styles: function (e) {
                ...
                return r.rect = {
                    ...
                    write: function () {
                        if (R(u, n)) return h(i.element, n), Object.assign(u, Object.assign({}, n)), !0
                    },
                    destroy: function () {}
                }
            },
                    ...
                    q = {
                        ...
                        _write: function (e, t, n) {
                            ...
                            return P.forEach(function (i) {
                                ...
                                r.element.parentNode || (Y.appendChild(r.element, i), r._read(), r._write(e, R(r, t), n), o = !1)
                            }), m = o, A({
                                props: r,
                                root: Y,
                                actions: t,
        ...
        W = {
            array: function (e) {
                ...
                return P(e) ? [] : L(e) ? e : C(e).split(t).map(M).filter(function (e) {
                    return e.length
                })
            },
            boolean: w,
            ...
            serverapi: function (e) {
                return (n = {}).url = G(t = e) ? t : t.url || "", n.timeout = t.timeout ? parseInt(t.timeout, 10) : 0, r(Y, function (e) {
        ...
        ue = ["fire", "process", "revert", "load", "on", "off", "onOnce", "retryLoad", "extend", "archive", "archived", "release", "released", "requestProcessing", "freeze"],
        se = function (e) {
            var t = {};
            return ae(e, t, ue), t
        },
        ...
        ve = {
            ...
            ignoredFiles: [
                [".ds_store", "thumbs.db", "desktop.ini"], de.ARRAY
            ],
            instantUpload: [!0, de.BOOLEAN],
            maxParallelUploads: [2, de.INT],
            server: [null, de.SERVER_API],
            labelDecimalSeparator: [pe(), de.STRING],
            labelThousandsSeparator: [(t = pe(), n = 1e3.toLocaleString(), n !== 1e3.toString() ? fe(n)[0] : "." === t ? "," : "."), de.STRING],
            labelIdle: ['把你的图片拖放到这里或者 <span class="filepond--label-action">浏览本地文件</span>', de.STRING],
            labelInvalidField: ["您选择的文件类型不被允许", de.STRING],
            labelFileWaitingForSize: ["正在获取大小", de.STRING],
            labelFileSizeNotAvailable: ["尺寸不允许", de.STRING],
            labelFileCountSingular: ["file in list", de.STRING],
            labelFileCountPlural: ["files in list", de.STRING],
            labelFileLoading: ["正在加载", de.STRING],
            labelFileAdded: ["已添加", de.STRING],
            labelFileLoadError: ["加载失败", de.STRING],
            labelFileRemoved: ["已删除", de.STRING],
            labelFileRemoveError: ["删除失败", de.STRING],
            labelFileProcessing: ["正在上传...", de.STRING],
            labelFileProcessingComplete: ["上传完毕", de.STRING],
            labelFileProcessingAborted: ["取消上传", de.STRING],
            labelFileProcessingError: ["上传错误", de.STRING],
            labelFileProcessingRevertError: ["恢复失败", de.STRING],
            labelTapToCancel: ["点击取消", de.STRING],
            labelTapToRetry: ["点击重试", de.STRING],
            labelTapToUndo: ["点击撤销", de.STRING],
            labelButtonRemoveItem: ["删除", de.STRING],
            labelButtonAbortItemLoad: ["Abort", de.STRING],
            labelButtonRetryItemLoad: ["重试", de.STRING],
            labelButtonAbortItemProcessing: ["取消", de.STRING],
            labelButtonUndoItemProcessing: ["撤销", de.STRING],
            labelButtonRetryItemProcessing: ["重试", de.STRING],
            labelButtonProcessItem: ["上传", de.STRING],
            iconRemove: ['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path d="M11.586 13l-2.293 2.293a1 1 0 0 0 1.414 1.414L13 14.414l2.293 2.293a1 1 0 0 0 1.414-1.414L14.414 13l2.293-2.293a1 1 0 0 0-1.414-1.414L13 11.586l-2.293-2.293a1 1 0 0 0-1.414 1.414L11.586 13z" fill="currentColor" fill-rule="nonzero"/></svg>', de.STRING],
            iconProcess: ['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path d="M14 10.414v3.585a1 1 0 0 1-2 0v-3.585l-1.293 1.293a1 1 0 0 1-1.414-1.415l3-3a1 1 0 0 1 1.414 0l3 3a1 1 0 0 1-1.414 1.415L14 10.414zM9 18a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2H9z" fill="currentColor" fill-rule="evenodd"/></svg>', de.STRING],
            iconRetry: ['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path d="M10.81 9.185l-.038.02A4.997 4.997 0 0 0 8 13.683a5 5 0 0 0 5 5 5 5 0 0 0 5-5 1 1 0 0 1 2 0A7 7 0 1 1 9.722 7.496l-.842-.21a.999.999 0 1 1 .484-1.94l3.23.806c.535.133.86.675.73 1.21l-.804 3.233a.997.997 0 0 1-1.21.73.997.997 0 0 1-.73-1.21l.23-.928v-.002z" fill="currentColor" fill-rule="nonzero"/></svg>', de.STRING],
            iconUndo: ['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path d="M9.185 10.81l.02-.038A4.997 4.997 0 0 1 13.683 8a5 5 0 0 1 5 5 5 5 0 0 1-5 5 1 1 0 0 0 0 2A7 7 0 1 0 7.496 9.722l-.21-.842a.999.999 0 1 0-1.94.484l.806 3.23c.133.535.675.86 1.21.73l3.233-.803a.997.997 0 0 0 .73-1.21.997.997 0 0 0-1.21-.73l-.928.23-.002-.001z" fill="currentColor" fill-rule="nonzero"/></svg>', de.STRING],
            iconDone: ['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"><path d="M18.293 9.293a1 1 0 0 1 1.414 1.414l-7.002 7a1 1 0 0 1-1.414 0l-3.998-4a1 1 0 1 1 1.414-1.414L12 15.586l6.294-6.293z" fill="currentColor" fill-rule="nonzero"/></svg>', de.STRING],
        ...
        ge = function (e, t) {
            return P(t) ? e[0] || null : F(t) ? e[t] || null : ("object" == typeof t && (t = t.id), e.find(function (e) {
                return e.id === t
            }) || null)
        },
        Re = function (e) {
        ...
        Pe = function (e) {
            return {
                ...
                GET_PANEL_ASPECT_RATIO: function () {
                    return /circle/.test(e.options.stylePanelLayout) ? 1 : Re(e.options.stylePanelAspectRatio)
                },
        ...
        Be = function (e, t) {
            ...
            return o.lastModifiedDate = new Date, G(t) || (t = Ue()), t && null === r && we(t) ? o.name = t : (r = r || function (e) {
            ...
            var t = {
                ...
                n = function (n) {
                    e ? (t.timestamp = Date.now(), t.request = e(n, function (e) {
                        t.duration = Date.now() - t.timestamp, t.complete = !0, e instanceof Blob && (e = Be(e, Ne(n))), r.fire("load", e instanceof Blob ? e : e.body)
                    }, function (e) {
                ...
                r = Object.assign({}, ie(), {
                    ...
                    load: function () {
                        var e, o, i = t.source;
                        r.fire("init", i), i instanceof File ? r.fire("load", i) : i instanceof Blob ? r.fire("load", Be(i, i.name)) : Ce(i) ? r.fire("load", Be(qe(i), e, null, o)) : n(i)
                    }
                });
            return r
        },
        ...
        ze = function (e, t, n) {
            ...
            n = Object.assign({
                ...
                headers: {},
                withCredentials: !1
            }, n), t = encodeURI(t), We(n.method) && e && (t = "" + t + encodeURIComponent("string" == typeof e ? e : JSON.stringify(e)));
            var a = new XMLHttpRequest;
            return (We(n.method) ? a : a.upload).onprogress = function (e) {
        ...
        Ze = function () {
            ...
            return function (o, i, a, u, s, l) {
                ...
                return c.onload = function (e) {
                    ...
                    a(ke("error", e.status, r(e.response) || e.statusText, e.getAllResponseHeaders()))
                }, c.onheaders = function (e) {
                    l(ke("headers", e.status, null, e.getAllResponseHeaders()))
                }, c.ontimeout = Qe(a), c.onprogress = u, c.onabort = s, c
            }
        },
        $e = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            ...
            var t = {
                ...
                r = Object.assign({}, ie(), {
                    process: function (n, o) {
                        ...
                        }, Ke(750, 1500)), t.request = e(n, o, function (e) {
                            t.response = H(e) ? e : {
                                type: "load",
                                code: 200,
                                body: "" + e,
        ...
        nt = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                ...
                f = Object.assign({
                    ...
                    abortLoad: function () {
                        i.activeLoader ? i.activeLoader.abort() : (s(le.INIT), l("load-abort"))
                    },
                    retryLoad: function () {
                    ...
                    abortProcessing: function () {
                        return new Promise(function (e) {
                            if (!i.activeProcessor) return s(le.IDLE), l("process-abort"), void e();
                            a = function () {
                                e()
                    ...
                    load: function (t, n, r) {
                        i.source = t, i.file ? l("load-skip") : (i.file = function (e) {
                            ...
                            return e instanceof Blob || Ce(e) ? t[0] = e.name || Ue() : Ce(e) ? (t[1] = e.length, t[2] = Fe(e)) : G(e) && (t[0] = Ne(e), t[1] = 0, t[2] = "application/octet-stream"), {
                                name: t[0],
                                size: t[1],
                                type: t[2]
                            }
                            ...
                            i.activeLoader = null;
                            var n = function (t) {
                                i.file = tt(t) ? t : i.file, e === ce.LIMBO && i.serverFileReference ? s(le.PROCESSING_COMPLETE) : s(le.IDLE), l("load")
                            };
                            i.serverFileReference ? n(t) : r(t, n, function (e) {
                                i.file = t, l("load-meta"), s(le.LOAD_ERROR), l("load-file-error", e)
                            })
                        }), n.setSource(t), i.activeLoader = n, n.load())
                    },
                    process: function e(t, n) {
                        s(le.PROCESSING), a = null, i.file instanceof Blob ? (t.on("load", function (e) {
                            i.serverFileReference = e
                        }), t.on("load-perceived", function (e) {
                            i.activeProcessor = null, i.serverFileReference = e, s(le.PROCESSING_COMPLETE), l("process-complete", e)
                        }), t.on("start", function () {
                            l("process-start")
                        }), t.on("error", function (e) {
                            i.activeProcessor = null, s(le.PROCESSING_ERROR), l("process-error", e)
                        }), t.on("abort", function (e) {
                            i.activeProcessor = null, i.serverFileReference = e, s(le.IDLE), l("process-abort"), a && a()
                        }), t.on("progress", function (e) {
                            l("process-progress", e)
                        }), n(i.file, function (e) {
                            i.archived || t.process(e, Object.assign({}, u))
                        }, function (e) {}), i.activeProcessor = t) : f.on("load", function () {
                            e(t, n)
                        })
                    },
                    revert: function (e, t) {
                        return new Promise(function (n, r) {
                            null !== i.serverFileReference ? (e(i.serverFileReference, function () {
                                ...
                                t ? (s(le.PROCESSING_REVERT_ERROR), l("process-revert-error"), r(e)) : n()
                            }), s(le.IDLE), l("process-revert")) : n()
                        })
                    }
                }, ie(), {
                    freeze: function () {
        ...
        ft = function (e, t, n) {
            return {
                ...
                DID_SET_FILES: function (t) {
                    ...
                    }), i = he(n.items), o.forEach(function (t, n) {
                        i.find(function (e) {
                ...
                DID_UPDATE_ITEM_METADATA: function (r) {
                    ...
                    clearTimeout(n.itemUpdateTimeout), n.itemUpdateTimeout = setTimeout(function () {
                        ...
                        if (t("IS_ASYNC")) {
                            ...
                            return r.status === le.PROCESSING_COMPLETE ? (i = n.options.instantUpload, void r.revert($e(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")).then(i ? a : function () {}).catch(function () {})) : r.status === le.PROCESSING ? function (e) {
                ...
                ADD_ITEM: function (r) {
                    ...
                    if (P(o)) f({
                    ...
                    else if (!tt(o) || !n.options.ignoredFiles.includes(o.name.toLowerCase())) {
                        if (! function (e) {
                            ...
                            if (_.status === le.PROCESSING_COMPLETE || _.status === le.PROCESSING_REVERT_ERROR) {
                                ...
                                if (_.revert($e(n.options.server.url, n.options.server.revert), T).then(function () {
                                        T && e("ADD_ITEM", {
                                            source: o,
                                            index: a,
                                            interactionMethod: u,
                        ...
                        var I = "local" === d.type ? ce.LOCAL : "limbo" === d.type ? ce.LIMBO : ce.INPUT,
                            m = nt(I, I === ce.INPUT ? null : o, d.file);
                        Object.keys(d.metadata || {}).forEach(function (e) {
                            m.setMetadata(e, d.metadata[e])
                        }), Te("DID_CREATE_ITEM", m, {
                            query: t,
                            dispatch: e
                        });
                        var v = t("GET_ITEM_INSERT_LOCATION");
                        n.options.itemInsertLocationFreedom || (a = "before" === v ? -1 : n.items.length), Me(n.items, m, a), x(v) && o && lt(n, v);
                        var g = m.id;
                        m.on("load-init", function () {
                            ...
                            var r = function (r) {
                                r ? (m.on("metadata-update", function (t) {
                        ...
                        var R = n.options.server || {},
                            ...
                            D = R.restore,
                            y = R.fetch;
                        m.load(o, Xe(I === ce.INPUT ? G(o) && function (e) {
                            return (e.indexOf(":") > -1 || e.indexOf("//") > -1) && it(location.href) !== it(e)
                        }(o) ? Ze(h, y) : ot : Ze(h, I === ce.LIMBO ? D : O)), function (e, n, r) {
                            _e("LOAD_FILE", e, {
                                query: t
                            }).then(n).catch(r)
                        })
                ...
                COMPLETE_LOAD_ITEM: function (r) {
                    ...
                    x(s) && u && lt(n, s), e("DID_LOAD_ITEM", {
                        id: o.id,
                        error: null,
                        serverFileReference: o.origin === ce.INPUT ? null : u
                    }), a(se(o)), o.origin !== ce.LOCAL ? o.origin !== ce.LIMBO ? t("IS_ASYNC") && n.options.instantUpload && e("REQUEST_ITEM_PROCESSING", {
                        query: o.id
                    }) : e("DID_COMPLETE_ITEM_PROCESSING", {
                        id: o.id,
                        error: null,
                ...
                REQUEST_ITEM_PROCESSING: ct(n, function (r, o, i) {
                    if (r.status === le.IDLE || r.status === le.PROCESSING_ERROR) r.status !== le.PROCESSING_QUEUED && (r.requestProcessing(), e("DID_REQUEST_ITEM_PROCESSING", {
                        ...
                        r.status === le.PROCESSING_COMPLETE || r.status === le.PROCESSING_REVERT_ERROR ? r.revert($e(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")).then(a).catch(function () {}) : r.status === le.PROCESSING && r.abortProcessing().then(a)
                    }
                }),
                    ...
                    if (t("GET_ITEMS_BY_STATUS", le.PROCESSING).length !== a) {
                        if (r.status !== le.PROCESSING) {
                            ...
                            r.onOnce("process-complete", function () {
                                o(se(r)), u(), t("GET_ITEMS_BY_STATUS", le.PROCESSING_COMPLETE).length === n.items.length && e("DID_COMPLETE_ITEM_PROCESSING_ALL")
                            }), r.onOnce("process-error", function (e) {
                                i({
                                    error: e,
                                    file: se(r)
                                }), u()
                            }), r.process(Je(function () {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
                                    t = arguments.length > 1 ? arguments[1] : void 0,
                                ...
                                } : t && G(t.url) ? function (r, o, i, a, u, s) {
                                    var l = t.ondata || function (e) {
                                            return e
                                        },
                                        c = t.onload || function (e) {
                                            return e
                                        },
                                        f = t.onerror || function (e) {
                                            return null
                                        };
                                    if (r) {
                                        var p = new FormData;
                                        H(o) && p.append(n, JSON.stringify(o)), (r instanceof Blob ? [{
                                            name: null,
                                            file: r
                                        }] : r).forEach(function (e) {
                                            p.append(n, e.file, null === e.name ? e.file.name : "" + e.name + e.file.name)
                                        });
                                        var d = ze(l(p), e + t.url, t);
                                        return d.onload = function (e) {
                                            i(ke("load", e.status, c(e.response), e.getAllResponseHeaders()))
                                        }, d.onerror = function (e) {
                                            a(ke("error", e.status, f(e.response) || e.statusText, e.getAllResponseHeaders()))
                                        }, d.ontimeout = Qe(a), d.onprogress = u, d.onabort = s, d
                                    }
                                } : null
                            }(n.options.server.url, n.options.server.process, n.options.name)), function (n, o, i) {
                                _e("PREPARE_OUTPUT", n, {
                                    query: t,
                                    item: r
                                }).then(function (t) {
                ...
                REMOVE_ITEM: ct(n, function (t, r) {
                    var o = function () {
                            var o = t.id;
                            rt(n.items, o).archive(), e("DID_REMOVE_ITEM", {
                                error: null,
                                id: o,
                                item: t
                            }), ut(e, n), r(se(t))
                ...
                REVERT_ITEM_PROCESSING: ct(n, function (r) {
                    r.revert($e(n.options.server.url, n.options.server.revert), t("GET_FORCE_REVERT")).then(function () {
        ...
        vt = function (e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ".";
            return (e = Math.round(Math.abs(e))) < 1e3 ? e + " bytes" : e < Rt ? Math.floor(e / gt) + " KB" : e < ht ? Ot(e / Rt, 1, t) + " MB" : Ot(e / ht, 2, t) + " GB"
        },
        gt = 1e3,
        Rt = 1e6,
        ht = 1e9,
        ...
        Dt = function (e) {
            var t = e.root,
                n = e.props;
            Et(t.ref.fileSize, vt(t.query("GET_ITEM_SIZE", n.id))), Et(t.ref.fileName, pt(t.query("GET_ITEM_NAME", n.id)))
        },
        yt = function (e) {
            var t = e.root,
                n = e.props;
            F(t.query("GET_ITEM_SIZE", n.id)) || Et(t.ref.fileSize, t.query("GET_LABEL_FILE_SIZE_NOT_AVAILABLE"))
        },
        St = y({
            name: "file-info",
            ignoreRect: !0,
            ...
            create: function (e) {
                ...
                var o = dt("span");
                o.className = "filepond--file-info-sub", t.appendChild(o), t.ref.fileSize = o, Et(o, t.query("GET_LABEL_FILE_WAITING_FOR_SIZE")), Et(r, pt(t.query("GET_ITEM_NAME", n.id)))
            },
            mixins: {
        ...
        bt = function (e) {
            var t = e.root,
                n = e.action,
                r = null === n.progress ? t.query("GET_LABEL_FILE_LOADING") : t.query("GET_LABEL_FILE_LOADING") + " " + At(n.progress) + "%";
        ...
        Mt = y({
            ...
            write: S({
                ...
                DID_REQUEST_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Et(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING")), Et(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"))
                },
                DID_ABORT_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Et(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_ABORTED")), Et(t.ref.sub, t.query("GET_LABEL_TAP_TO_RETRY"))
                },
                DID_COMPLETE_ITEM_PROCESSING: function (e) {
                    var t = e.root;
                    Et(t.ref.main, t.query("GET_LABEL_FILE_PROCESSING_COMPLETE")), Et(t.ref.sub, t.query("GET_LABEL_TAP_TO_UNDO"))
                },
                DID_UPDATE_ITEM_PROCESS_PROGRESS: function (e) {
                    var t = e.root,
                        n = e.action,
                        r = null === n.progress ? t.query("GET_LABEL_FILE_PROCESSING") : t.query("GET_LABEL_FILE_PROCESSING") + " " + At(n.progress) + "%";
                    Et(t.ref.main, r), Et(t.ref.sub, t.query("GET_LABEL_TAP_TO_CANCEL"))
                },
            ...
            create: function (e) {
                ...
                var r = dt("span");
                r.className = "filepond--file-status-sub", t.appendChild(r), t.ref.sub = r, bt({
                    root: t,
                    action: {
                        progress: null
                    }
    ...
    var wt, Gt = function (e) {
        ...
        Xt = y({
            create: function (e) {
                var t = e.root,
                    ...
                    a = t.query("IS_ASYNC"),
                    u = a ? Nt.concat() : Nt.filter(function (e) {
                        return !/Process/.test(e)
                    });
                if (a && !o) {
                    u.splice(-1, 1);
                    var s = Yt.DID_COMPLETE_ITEM_PROCESSING;
                    s.info.translateX = Bt, s.info.translateY = Ut, s.status.translateY = Ut, s.processingCompleteIndicator = {
                        opacity: 1,
                        scaleX: 1,
                        scaleY: 1
                    }
                }
                i && o && (Ct.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM", Ct.RevertItemProcessing.icon = "GET_ICON_REMOVE"), r(Ct, function (e, r) {
                    var o = t.createChildView(mt, {
                        label: t.query(r.label),
                        icon: t.query(r.icon),
                        opacity: 0
                    });
                    u.includes(e) && t.appendChildView(o), o.element.dataset.align = t.query("GET_STYLE_" + r.align), o.element.classList.add(r.className), o.on("click", function (e) {
                        e.stopPropagation(), t.dispatch(r.action, {
                            query: n
                        })
                    }), t.ref["button" + e] = o
                }), t.ref.info = t.appendChildView(t.createChildView(St, {
                    id: n
                })), t.ref.status = t.appendChildView(t.createChildView(Mt, {
                    id: n
                })), t.ref.processingCompleteIndicator = t.appendChildView(t.createChildView(jt)), t.ref.processingCompleteIndicator.element.dataset.align = t.query("GET_STYLE_BUTTON_PROCESS_ITEM_POSITION");
                var l = t.appendChildView(t.createChildView(It, {
                    opacity: 0,
                ...
                var c = t.appendChildView(t.createChildView(It, {
                    opacity: 0,
        ...
        Wt = y({
            create: function (e) {
                var t = e.root,
                    n = e.props;
                t.ref.fileName = dt("legend"), t.appendChild(t.ref.fileName), t.ref.file = t.appendChildView(t.createChildView(Xt, {
                    id: n.id
                }));
                var r = dt("input");
            ...
            write: S({
                ...
                DID_LOAD_ITEM: function (e) {
                    var t = e.root,
                        n = e.action,
                        r = e.props;
                    t.ref.data.value = n.serverFileReference, Et(t.ref.fileName, pt(t.query("GET_ITEM_NAME", r.id)))
                },
        ...
        Jt = y({
            create: function (e) {
                ...
                }, t.element.id = "filepond--item-" + n.id, t.element.addEventListener("click", t.ref.handleClick), t.ref.container = t.appendChildView(t.createChildView(Wt, {
                    id: n.id
                })), t.ref.panel = t.appendChildView(t.createChildView(Qt, {
                    name: "item-panel"
            ...
            write: function (e) {
                ...
                i && i.type !== r.currentState && (r.currentState = i.type, t.element.dataset.filepondItemState = $t[r.currentState] || "");
                var a = t.query("GET_ITEM_PANEL_ASPECT_RATIO") || t.query("GET_PANEL_ASPECT_RATIO");
                a ? o || (t.height = t.rect.element.width * a) : (Kt({
                    root: t,
                    actions: n,
                    props: r
        ...
        en = function (e, t) {
            if (t) {
                ...
                if (1 === l) {
                    for (var c = 0; c < o; c++) {
                        var f = r[c],
                            p = f.rect.outer.top + .5 * f.rect.element.height;
                        if (t.top < p) return c
                    }
                    return o
                }
                for (var d = a.marginTop + a.marginBottom, E = a.height + d, _ = 0; _ < o; _++) {
                    var T = _ % l * s,
                        I = Math.floor(_ / l) * E,
                        m = I - a.marginTop,
                        v = T + s,
        ...
        tn = function (e, t, n) {
            ...
            e.translateX = t, e.translateY = n, Date.now() > e.spawnDate && (0 === e.opacity && nn(e, t, n, r, o), e.scaleX = 1, e.scaleY = 1, e.opacity = 1)
        },
        ...
        rn = S({
            DID_ADD_ITEM: function (e) {
                ...
                t.ref.lastItemSpanwDate = u, t.appendChildView(t.createChildView(Jt, {
                    spawnDate: u,
                    id: r,
                    opacity: s,
                    interactionMethod: i
                ...
                if (0 !== l.length) {
                    ...
                    if (1 === v) {
                        ...
                        l.forEach(function (e, t) {
                            ...
                            o && (e.translateX = null, e.translateY = null), e.markedForRemoval || tn(e, 0, g + R);
                        ...
                        var h = 0,
                            O = 0;
                        l.forEach(function (e, t) {
                            t === a && (f = 1), t === c && (d += 1), e.markedForRemoval && e.opacity < .5 && (p -= 1);
                            var n = t + d + f + p,
                                r = n % v,
                                i = Math.floor(n / v),
                                u = r * I,
                                ...
                                l = Math.sign(u - h),
                                E = Math.sign(s - O);
                            h = u, O = s, e.markedForRemoval || (o && (e.translateX = null, e.translateY = null), tn(e, u, s, l, E))
                        })
                    }
                }
            },
        ...
        _n = y({
            ...
            create: function (e) {
                var t = e.root,
                    n = e.props,
                    r = dt("label");
                i(r, "for", "filepond--browser-" + n.id), i(r, "id", "filepond--drop-label-" + n.id), i(r, "aria-hidden", "true"), r.addEventListener("keydown", function (e) {
                    (e.keyCode === pn || e.keyCode === dn) && (e.preventDefault(), t.ref.label.click())
                }), t.element.addEventListener("click", function (e) {
                    e.target === r || r.contains(e.target) || t.ref.label.click()
                }), En(r, n.caption), t.appendChild(r), t.ref.label = r
            },
            write: S({
        ...
        In = S({
            DID_DRAG: function (e) {
                ...
                t.ref.blob ? (t.ref.blob.translateX = n.position.scopeLeft, t.ref.blob.translateY = n.position.scopeTop, t.ref.blob.scaleX = 1, t.ref.blob.scaleY = 1, t.ref.blob.opacity = 1) : function (e) {
                    ...
                    t.ref.blob = t.appendChildView(t.createChildView(Tn, {
                        opacity: 0,
                        scaleX: 2.5,
                        scaleY: 2.5,
                        translateX: n,
        ...
        hn = function () {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
            return e = e.toLowerCase(), vn.includes(e) ? "image/" + ("jpg" === e ? "jpeg" : "svg" === e ? "svg+xml" : e) : gn.includes(e) ? "text/" + e : Rn[e] || null
        },
        On = function (e) {
                ...
                ! function e(n) {
                    n.createReader().readEntries(function (n) {
                        n.forEach(function (n) {
                            n.isDirectory ? e(n) : (o++, n.file(function (e) {
        ...
        bn = function (e) {
            ...
            var t = e.lastModifiedDate,
                n = e.name;
            return (e = e.slice(0, e.size, hn(we(e.name)))).name = n, e.lastModifiedDate = t, e
        },
        Ln = function (e) {
        ...
        Vn = function (e) {
            ...
            var i = {
                ...
                addListener: function (a) {
                    return t.push(a),
                        function () {
                            t.splice(t.indexOf(a), 1), 0 === t.length && (Gn.splice(Gn.indexOf(i), 1), r(n, function (t) {
        ...
        Yn = function (e, t) {
            return function (e) {
                e.preventDefault(), qn = e.target, t.forEach(function (t) {
                    var n = t.element,
                        r = t.onenter;
            ...
            return function (e) {
                ...
                On(n).then(function (r) {
                    ...
                    t.some(function (t) {
                        ...
                        if (f)
                            if (Fn(e, a)) {
                                if (o = !0, null === t.state) return t.state = "enter", void u(Un(e));
                                if (t.state = "over", i && !f) return void xn(n, "none");
                                l(Un(e))
                            } else i && !o && xn(n, "none"), t.state && (t.state = null, s(Un(e)));
                        else xn(n, "none")
                    })
                })
            }
        ...
        Xn = function (e, t) {
            return function (e) {
                qn === e.target && t.forEach(function (t) {
                    var n = t.onexit;
                    t.state = null, n(Un(e))
                })
            }
        ...
        Qn = function (e) {
            On(e.clipboardData).then(function (e) {
                e.length && kn.forEach(function (t) {
                    return t(e)
                })
            })
        },
        Zn = function () {
            var e = function (e) {
                ...
                t = {
                    destroy: function () {
                        var t;
                        t = e, oe(kn, kn.indexOf(t)), 0 === kn.length && (document.removeEventListener("paste", Qn), zn = !1)
                    },
                    onload: function () {}
                };
            return function (e) {
                kn.includes(e) || (kn.push(e), zn || (zn = !0, document.addEventListener("paste", Qn)))
            }(e), t
        },
        $n = null,
        Kn = null,
        ...
        tr = function (e, t, n) {
            ...
            er(e, n + " " + t + ", " + r + " " + (1 === r ? e.query("GET_LABEL_FILE_COUNT_SINGULAR") : e.query("GET_LABEL_FILE_COUNT_PLURAL"))), clearTimeout(Kn), Kn = setTimeout(function () {
                ! function (e) {
            ...
            write: S({
                DID_LOAD_ITEM: function (e) {
                    ...
                    if (nr(t)) {
                        ...
                        Jn.push(r.filename), clearTimeout($n), $n = setTimeout(function () {
                            tr(t, Jn.join(", "), t.query("GET_LABEL_FILE_ADDED")), Jn.length = 0
                        }, 750)
                    }
                },
                DID_REMOVE_ITEM: function (e) {
        ...
        dr = function (e) {
            ...
            if (r && !e.ref.hopper) {
                ...
                }, e.ref.hopper = o, e.ref.drip = e.appendChildView(e.createChildView(mn))
        ...
        _r = function (e) {
            var t = e.query("GET_ALLOW_PASTE"),
                n = e.query("GET_DISABLED"),
                r = t && !n;
            r && !e.ref.paster ? (e.ref.paster = Zn(), e.ref.paster.onload = function (t) {
                e.dispatch("ADD_ITEMS", {
                    items: t,
                    index: -1,
        ...
        Tr = S({
            ...
            DID_SET_DISABLED: function (e) {
                var t = e.root,
                    n = e.props;
                dr(t), _r(t), Er(t, n), t.query("GET_DISABLED") ? t.element.dataset.disabled = "disabled" : delete t.element.dataset.disabled
            }
        }),
        Ir = y({
            name: "root",
            ...
            create: function (e) {
                ...
                o && o.split(" ").forEach(function (e) {
                ...
                }), t.ref.label = t.appendChildView(t.createChildView(_n, Object.assign({}, n, {
                    translateY: null,
                    ...
                    name: "panel-root"
                })), t.ref.assistant = t.appendChildView(t.createChildView(ir, Object.assign({}, n))), t.ref.measure = dt("div"), t.ref.measure.style.height = "100%", t.element.appendChild(t.ref.measure), t.ref.bounds = null, t.query("GET_STYLES").filter(function (e) {
                    return !P(e.value)
                }).map(function (e) {
                    var n = e.name,
                        r = e.value;
            ...
            write: function (e) {
                ...
                if (Tr({
                    ...
                    var o = t.ref.bounds;
                    o || (o = t.ref.bounds = cr(t), t.element.removeChild(t.ref.measure), t.ref.measure = null);
                    var i = t.ref,
                        a = i.hopper,
                        u = i.label,
                        s = i.list,
                    ...
                    if (d && E) {
                        ...
                        u.opacity = 0, f ? u.translateY = -40 : _ === K ? u.translateX = 40 : u.translateY = _ === ee ? 40 : 30
                    ...
                    var T = sr(t),
                        ...
                        h = v + g + I.visual + R,
                        O = v + g + I.bounds + R;
                    if (s.translateY = Math.max(0, v - s.rect.element.marginTop) - T.top, c) {
                        ...
                        I.visual > C ? s.overflow = C : s.overflow = null, t.height = y
                        ...
                        h > o.cappedHeight && I.visual > U ? s.overflow = U : s.overflow = null, t.height = Math.min(o.cappedHeight, O - T.top - T.bottom)
                    } else {
                        var B = p > 0 ? T.top + T.bottom : 0;
                        l.scalable = !0, l.height = Math.max(m, h - B), t.height = Math.max(m, O - B)
                    }
                }
            },
            destroy: function (e) {
        ...
        mr = function () {
            ...
            var d = Ir(i, {
                ...
                I = {
                    _read: function () {
                        s && (f = window.innerWidth, c || (c = f), l || f === c || (i.dispatch("DID_START_RESIZE"), l = !0)), T && _ && (_ = null === d.element.offsetParent), _ || (d._read(), T = d.rect.element.hidden)
                    },
                    _write: function (e) {
                        var t, n = i.processActionQueue().filter(function (e) {
                            return !/^SET_/.test(e.type)
                        });
                        _ && !n.length || (g(n), _ = d._write(e, n, l), (t = i.query("GET_ITEMS")).forEach(function (e, n) {
                            e.released && oe(t, n)
                ...
                m = function (e) {
                    return function (t) {
                        ...
                        return t.items && (n.items = t.items.map(se)), /progress/.test(e) && (n.progress = t.progress), n
                    }
                },
                v = {
                            ...
                            (Array.isArray(t) ? t : [t]).forEach(function (t) {
                                setTimeout(function () {
                                    ! function (e) {
                                        ...
                                        delete t.type, d.element.dispatchEvent(new CustomEvent("FilePond:" + e.type, {
                                            detail: t,
                                            bubbles: !0,
                                            cancelable: !0,
                                            composed: !0
                ...
                y = Object.assign({}, ie(), I, function (e, t) {
                    var n = {};
                    ...
                    destroy: function () {
                        y.fire("destroy", d.element), i.dispatch("ABORT_ALL"), d._destroy(), window.removeEventListener("resize", p), document.addEventListener("visibilitychange", a), i.dispatch("DID_DESTROY")
                    },
                    ...
                    restoreElement: function () {
                        t && (b(t, d.element), d.element.parentNode.removeChild(d.element), t = null)
                    },
        ...
        gr = function (e) {
            ...
            var o = n.filter(function (e) {
                ...
                var r, o = i(e, n.name);
                return t[(r = n.name, ar(r.replace(/^data-/, "")))] = o === n.name || o, t
            }, {});
                    ...
                    r(t, function (e, r) {
                        ...
                        if (i.test(e) && (delete t[e], !1 !== o))
                            if (G(o)) t[o] = r;
                                ...
                                var a, u = o.group;
                                H(o) && !t[u] && (t[u] = {}), t[u][(a = e.replace(i, ""), a.charAt(0).toLowerCase() + a.slice(1))] = r
                            }
        ...
        Rr = function () {
            return (arguments.length <= 0 ? void 0 : arguments[0]) instanceof HTMLElement ? function (e) {
                ...
                var r = Object.assign({}, t),
                    o = gr("FIELDSET" === e.nodeName ? e.querySelector("input[type=file]") : e, n);
            ...
            }.apply(void 0, arguments) : vr.apply(void 0, arguments)
        },
        ...
        Mr = (wt = "undefined" != typeof window && void 0 !== window.document && !("[object OperaMini]" === Object.prototype.toString.call(window.operamini)) && "visibilityState" in document && "Promise" in window && "slice" in Blob.prototype && "URL" in window && "createObjectURL" in window.URL && "performance" in window, function () {
            return wt
        }),
        Cr = {
            apps: []
        ...
        Nr = function () {};
    if (e.Status = {}, e.FileStatus = {}, e.FileOrigin = {}, e.OptionTypes = {}, e.create = Nr, e.destroy = Nr, e.parse = Nr, e.find = Nr, e.registerPlugin = Nr, e.getOptions = Nr, e.setOptions = Nr, Mr()) {
        ! function (e, t) {
        ...
        "loading" !== document.readyState ? setTimeout(function () {
            return wr()
        }, 0) : document.addEventListener("DOMContentLoaded", wr);
        var Gr = function () {
            return r(me(), function (t, n) {
                e.OptionTypes[t] = n[1]
            })
        };
        e.Status = Object.assign({}, Oe), e.FileOrigin = Object.assign({}, ce), e.FileStatus = Object.assign({}, le), e.OptionTypes = {}, Gr(), e.create = function () {
            ...
            return H(t) && (Cr.apps.forEach(function (e) {
                e.setOptions(t)
            }), function (e) {
                r(e, function (e, t) {
    ...
    e.supported = Mr, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});
