    ...
    <div class="card border-light mb-3">
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <a href="{{ route('download',['clientId' => $clientId,'query' => \App\Utils\Tool::encodeUrl($originPath)]) }}" class="btn btn-success"><i
                        class="fa fa-download"></i> 下载</a>
                &nbsp;&nbsp;
                <a href="{{ route('view',['clientId' => $clientId,'query' => \App\Utils\Tool::encodeUrl($originPath)]) }}" data-fancybox="image-list"
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <input type="text" id="link1" class="form-control"
                           value="{{ route('view',['clientId' => $clientId,'query' => \App\Utils\Tool::encodeUrl($originPath)]) }}">
            ...
            <div class="form-group">
                <div class="input-group mb-3">
                    <input type="text" id="link3" class="form-control"
                           value="<img src='{{ route('view',['clientId' => $clientId,'query' => \App\Utils\Tool::encodeUrl($originPath)]) }}' />">
                    <div class="input-group-append">
                        <a href="javascript:void(0)" style="text-decoration: none" data-toggle="tooltip"
